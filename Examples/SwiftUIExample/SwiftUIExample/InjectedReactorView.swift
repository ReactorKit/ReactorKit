...
//
//        Group {
//          Text("• reactor.currentState.value: \(reactor.currentState.value)")
//          Text("• reactor.value: \(reactor.value)")
//          Text("• reactor(.action) - function call")
//          Text("• reactor.action.onNext(.action) - explicit")
//        }
//        .font(.caption2)
//        .foregroundColor(.secondary)
//      }
...
//
//      HStack {
//        Button("-") { reactor.action.onNext(.decrease) }
//        Button("Reset") { reactor.action.onNext(.reset) }
//        Button("+") { reactor.action.onNext(.increase) }
//      }
//      .buttonStyle(.bordered)
//      .controlSize(.small)
//    }
